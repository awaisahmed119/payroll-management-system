 ...
 * @author waleed
 */
public class MedicalAllowance extends allowance{
    int fixed = 1500;
    int val=0;

    public MedicalAllowance(String ObjectDetail, String ObjectHead) {
        ...
        if(scale >=1 && scale <= 15){
          ...
          if(check(id,"A01217")){
            ...
            try{
                 ...
                 String sql ="update empallowances set A01217_med="+val+" where empid="+"'"+id+"'" ;
